...
> [!NOTE]
> If you want to use horizontal swiping features, you should use **[SwipeControl](swipe-control.md)** instead.
>
> [!NOTE]
> To know more about how plugin can handle lists, please see **[Properties Tab](../learn/developers/properties-tab.md)**.
...
| Primary Commands   | `True/False`        | Adds 2 **Buttons** at the bottom of the **ListItem**         |
...
- **Leading**: Allows you to change the components that will be displayed at the top left of the **ListItem**. It will only be displayed if the **Leading** property is enabled. The possible components are :
  ...
  - **CheckBox**: See **[CheckBox](check-box.md)** for all the possible customizations.
  - **PersonPicture**: See **[PersonPicture](person-picture.md)** for all the possible customizations.
  - **Image**: The default option. See **[Image](image.md)** for all the possible customizations.
